---
id: update-store-by-id-delivery
title: Update Store Delivery
sidebar_label: Update Store Delivery
---
...
| `function` | String | Function that provide by alacarte | "update.store.delivery"      |
...
--data-raw '{
  "service": "alacarte",
  "version": "v1",
  "function": "update.store.delivery",
  "request": {
